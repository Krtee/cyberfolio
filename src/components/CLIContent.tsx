const CLIContent = () => {
  return (
    <div
      className=" overscroll-contain relative w-full bg-cement xl:px-40"
      data-lenis-prevent
    >
      <p className="relative text-black evangelion text-7xl md:text-[250px] text-center pt-40 md:pt-10 ">
        DEVDUCK CLI
      </p>
      <div className=" relative translate-y-[-3%] md:translate-y-[-10%] xl:translate-y-[-8%] mx-auto ">
        <div className="relative  w-2/3 mx-auto flex flex-row gap-10 max-w-[900px] ">
          <img
            className="flex-auto"
          ...
          <div className="flex-auto">
            <div className="  flex flex-col md:flex-row gap-10 w-full">
              ...
              <div className="max-w-[80vw] md:max-w-[30vw] ml-auto mr-0">
                <p className="relative text-black evangelion text-5xl md:text-[100px] pl-20 md:leading-[90px] text-right">
                  DEVDUCK CLI
                </p>
                <p className="relative akira text-black  text-justify hyphens-auto break-normal text-wrap leading-[20px] ">
                  For my bachelor thesis I created a command line tool that can
                  automatically set up all the necessary services for a
                  progressive web app.
                </p>
                <p className=" akira text-black  text-2xl py-10 md:py-20 text-justify break-keep">
